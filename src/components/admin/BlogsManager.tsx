            ...
            >
              ...
              <div className="relative aspect-video overflow-hidden bg-zinc-100 border-b border-zinc-100">
                ...
                <div className="absolute top-2 left-2">
                  <span className="text-[7px] md:text-[10px] font-black uppercase tracking-wider px-2 py-0.5 md:px-3 md:py-1 rounded-full border shadow-sm backdrop-blur-md bg-white/90 text-amber-700 border-amber-200">
                    {post.category}
                  </span>
                </div>
              </div>
              ...
              <div className="p-3 md:p-5 flex flex-col flex-1">
                <div className="mb-3">
                  <h4 className="text-zinc-900 font-black text-xs md:text-base leading-tight mb-0.5 group-hover:text-amber-600 transition-colors line-clamp-2">
                    {post.title}
                  </h4>
      ...
      {confirmDelete && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/20 backdrop-blur-sm">
          <div className="bg-white border border-zinc-200 rounded-2xl p-7 w-full max-w-sm shadow-2xl text-center">
            ...
            <h3 className="text-zinc-900 font-black text-lg mb-2">Delete Post?</h3>
